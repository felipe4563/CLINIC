...
const staffComprasRoutes = require('./routes/staffCompras');
const staffPerfilRoutes = require('./routes/staffPerfil');
...
app.use('/', staffComprasRoutes);
app.use('/', staffPerfilRoutes);
